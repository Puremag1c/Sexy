...
defmodule AddPendingPaidMessageReaction do
  ...
  defstruct "@type": "addPendingPaidMessageReaction", "@extra": nil, chat_id: nil, message_id: nil, star_count: nil, use_default_is_anonymous: nil, is_anonymous: nil
end
...
defmodule GetMainWebApp do
  ...
  defstruct "@type": "getMainWebApp", "@extra": nil, chat_id: nil, bot_user_id: nil, start_parameter: nil, theme: nil, application_name: nil
end
...
defmodule EditStoryCover do
  ...
  defstruct "@type": "editStoryCover", "@extra": nil, story_sender_chat_id: nil, story_id: nil, cover_frame_timestamp: nil
end
...
defmodule TogglePaidMessageReactionIsAnonymous do
  ...
  defstruct "@type": "togglePaidMessageReactionIsAnonymous", "@extra": nil, chat_id: nil, message_id: nil, is_anonymous: nil
end
