defmodule Sexy.TDL.Method do
  ...
  defmodule GetWebAppLinkUrl do
    ...
    | application_name | string | Short name of the current application; 0-64 English letters, digits, and underscores. |
  ...
  defmodule EditMessageCaption do
    ...
    | show_caption_above_media | bool | Pass true to show the caption above the media; otherwise, the caption will be shown below the media. Can be true only for animation, photo, and video messages. |
  ...
  defmodule UnpinAllMessageThreadMessages do
    ...
    defstruct "@type": "unpinAllMessageThreadMessages",
              "@extra": nil,
              chat_id: nil,
  ...
  defmodule GetChatRevenueTransactions do
    ...
    | limit | number | The maximum number of transactions to be returned; up to 200. |
  ...
  defmodule EditMessageLiveLocation do
    ...
    | live_period | number | New time relative to the message send date, for which the location can be updated, in seconds. If 0x7FFFFFFF specified, then the location can be updated forever. Otherwise, must not exceed the current live_period by more than a day, and the live location expiration date must remain in the next 90 days. Pass 0 to keep the current live_period. |
  ...
  defmodule SendMessage do
    ...
    |------|------| ------------|
    | chat_id | string | Target chat. |
    | message_thread_id | string | If not 0, the message thread identifier in which the message will be sent. |
  ...
  defmodule SearchSavedMessages do
    ...
    | offset | number | Specify 0 to get results from exactly the message from_message_id or a negative offset to get the specified message and some newer messages. |
  ...
  defmodule GetChatMessageCount do
    ...
    | saved_messages_topic_id | string | If not 0, only messages in the specified Saved Messages topic will be counted; pass 0 to count all messages, or for chats other than Saved Messages. |
  ...
  defmodule GetStarTransactions do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | owner_id | MessageSender | Identifier of the owner of the Telegram Stars; can be the identifier of the current user, identifier of an owned bot, or identifier of a channel chat with supergroupFullInfo.can_get_star_revenue_statistics == true. |
  ...
  defmodule ReadAllMessageThreadMentions do
    ...
    defstruct "@type": "readAllMessageThreadMentions",
              "@extra": nil,
              chat_id: nil,
              message_thread_id: nil
  end
  ...
  defmodule GetPremiumGiftCodePaymentOptions do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | boosted_chat_id | string | Identifier of the supergroup or channel chat, which will be automatically boosted by receivers of the gift codes and which is administered by the user; 0 if none. |
  ...
  defmodule AddPendingPaidMessageReaction do
    ...
    | use_default_is_anonymous | bool | Pass true if the user didn't choose anonymity explicitly, for example, the reaction is set from the message bubble. |
    | is_anonymous | bool | Pass true to make paid reaction of the user on the message anonymous; pass false to make the user's profile visible among top reactors. Ignored if use_default_is_anonymous == true. |
  ...
  defmodule SearchChatMessages do
    ...
    | saved_messages_topic_id | string | If not 0, only messages in the specified Saved Messages topic will be returned; pass 0 to return all messages, or for chats other than Saved Messages. |
  ...
  defmodule GetSavedMessagesTopicHistory do
    ...
    | from_message_id | string | Identifier of the message starting from which messages must be fetched; use 0 to get results from the last message. |
    | offset | number | Specify 0 to get results from exactly the message from_message_id or a negative offset up to 99 to get additionally some newer messages. |
  ...
  defmodule SetPinnedForumTopics do
    ...
    defstruct "@type": "setPinnedForumTopics",
              "@extra": nil,
              chat_id: nil,
              message_thread_ids: nil
  end
  ...
  defmodule SendChatAction do
    ...
    |------|------| ------------|
    | chat_id | string | Chat identifier. |
    | message_thread_id | string | If not 0, the message thread identifier in which the action was performed. |
  ...
  defmodule AddQuickReplyShortcutMessage do
    ...
    | shortcut_name | string | Name of the target shortcut. |
    | reply_to_message_id | string | Identifier of a quick reply message in the same shortcut to be replied; pass 0 if none. |
    | input_message_content | InputMessageContent | The content of the message to be added; inputMessagePoll, inputMessageForwarded and inputMessageLocation with live_period aren't supported. |
  ...
  defmodule GetChatMessageCalendar do
    ...
    | saved_messages_topic_id | string | If not0, only messages in the specified Saved Messages topic will be considered; pass 0 to consider all messages, or for chats other than Saved Messages. |
  ...
  defmodule ReportSupergroupSpam do
    ...
    | message_ids | string | Identifiers of messages to report. Use messageProperties.can_be_reported to check whether the message can be reported. |
  ...
  defmodule GetStarWithdrawalUrl do
    ...
    | star_count | string | The number of Telegram Stars to withdraw. Must be at least getOption("star_withdrawal_count_min"). |
    | password | string | The 2-step verification password of the current user. |
  ...
  defmodule ReadAllMessageThreadReactions do
    ...
    defstruct "@type": "readAllMessageThreadReactions",
              "@extra": nil,
              chat_id: nil,
              message_thread_id: nil
  end
  ...
  defmodule RefundStarPayment do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | user_id | string | Identifier of the user that did the payment. |
  ...
  defmodule ReportChat do
    ...
    |------|------| ------------|
    | chat_id | string | Chat identifier. |
    | message_ids | string | Identifiers of reported messages; may be empty to report the whole chat. Use messageProperties.can_be_reported to check whether the message can be reported. |
  ...
  defmodule EditQuickReplyMessage do
    ...
    | message_id | string | Identifier of the message. |
    | input_message_content | InputMessageContent | New content of the message. Must be one of the following types: inputMessageText, inputMessageAnimation, inputMessageAudio, inputMessageDocument, inputMessagePhoto or inputMessageVideo. |
  ...
  defmodule InviteGroupCallParticipants do
    ...
    defstruct "@type": "inviteGroupCallParticipants",
              "@extra": nil,
              group_call_id: nil,
              user_ids: nil
  end
  ...
  defmodule ReaddQuickReplyShortcutMessages do
    ...
    |------|------| ------------|
    | shortcut_name | string | Name of the target shortcut. |
    | message_ids | string | Identifiers of the quick reply messages to readd. Message identifiers must be in a strictly increasing order. |
  ...
  defmodule ForwardMessages do
    ...
    | message_thread_id | string | If not 0, the message thread identifier in which the message will be sent; for forum threads only. |
  ...
  defmodule GetChatMessagePosition do
    ...
    | saved_messages_topic_id | string | If not 0, only messages in the specified Saved Messages topic will be considered; pass 0 to consider all relevant messages, or for chats other than Saved Messages. |
  ...
  defmodule GetGroupCallInviteLink do
    ...
    defstruct "@type": "getGroupCallInviteLink",
              "@extra": nil,
              group_call_id: nil,
              can_self_unmute: nil
  end
  ...
  defmodule GetStarRevenueStatistics do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | owner_id | MessageSender | Identifier of the owner of the Telegram Stars; can be identifier of an owned bot, or identifier of a channel chat with supergroupFullInfo.can_get_star_revenue_statistics == true. |
    | is_dark | bool | Pass true if a dark theme is used by the application. |
  ...
  defmodule GetStarGiftPaymentOptions do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | user_id | string | Identifier of the user that will receive Telegram Stars; pass 0 to get options for an unspecified user. |
  ...
  defmodule SetChatDraftMessage do
    ...
    |------|------| ------------|
    | chat_id | string | Chat identifier. |
    | message_thread_id | string | If not 0, the message thread identifier in which the draft was changed. |
  ...
  defmodule CreateNewStickerSet do
    ...
    | user_id | string | Sticker set owner; ignored for regular users. |
    | title | string | Sticker set title; 1-64 characters. |
    | name | string | Sticker set name. Can contain only English letters, digits and underscores. Must end with "by<bot username>" (<bot_username> is case insensitive) for bots; 0-64 characters. If empty, then the name returned by getSuggestedStickerSetName will be used automatically. |
    ...
    | stickers | inputSticker | List of stickers to be added to the set; 1-200 stickers for custom emoji sticker sets, and 1-120 stickers otherwise. For TGS stickers, uploadStickerFile must be used before the sticker is shown. |
  ...
  defmodule TogglePaidMessageReactionIsAnonymous do
    @moduledoc """
    ...
    | chat_id | string | Identifier of the chat to which the message belongs. |
    | message_id | string | Identifier of the message. |
    | is_anonymous | bool | Pass true to make paid reaction of the user on the message anonymous; pass false to make the user's profile visible among top reactors. |

    More details on [telegram's documentation](https://core.telegram.org/tdlib/docs/classtd_1_1td__api_1_1toggle_paid_message_reaction_is_anonymous.html).
    """

    defstruct "@type": "togglePaidMessageReactionIsAnonymous",
              "@extra": nil,
              chat_id: nil,
              message_id: nil,
              is_anonymous: nil
  ...
  defmodule SendMessageAlbum do
    ...
    |------|------| ------------|
    | chat_id | string | Target chat. |
    | message_thread_id | string | If not 0, the message thread identifier in which the messages will be sent. |
    | reply_to | InputMessageReplyTo | Information about the message or story to be replied; pass null if none. |
    | options | messageSendOptions | Options to be used to send the messages; pass null to use default options. |
    | input_message_contents | InputMessageContent | Contents of messages to be sent. At most 10 messages can be added to an album. All messages must have the same value of show_caption_above_media. |
  ...
  defmodule SetApplicationVerificationToken do
    ...
    | Name | Type | Description |
    |------|------| ------------|
    | verification_id | string | Unique identifier for the verification process as received from updateApplicationVerificationRequired. |
